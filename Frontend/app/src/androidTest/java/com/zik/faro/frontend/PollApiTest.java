...
public class PollApiTest extends ApiBaseTest{
    ...
    public void testCreateGetPoll() throws InterruptedException, MalformedURLException {
        ...
        TestPollGetCallback votedPoll = new TestPollGetCallback(waitSem, 200);
        serviceHandler.getPollHandler().getPoll(votedPoll, eventId, receivedPoll.getId());
        Poll p = votedPoll.receivedPoll;
